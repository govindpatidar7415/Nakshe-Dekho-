...
public class HomeController {
	...
	public String index(Model m) {
		...
		List<Project> allActiveProjects = projectService.getAllActiveProjects("").stream()
				.sorted((p1, p2) -> p2.getId().compareTo(p1.getId())).limit(8).toList();
		
		m.addAttribute("category", allActiveCategory);
		m.addAttribute("products", allActiveProducts);
		m.addAttribute("projects", allActiveProjects);
...
//					System.out.println(path);
	...
	@GetMapping("/project")
	public String loadViewProject(Model m, @RequestParam(value = "category", defaultValue = "") String category,
	@RequestParam(name = "pageNo", defaultValue = "0") Integer pageNo,
	@RequestParam(name = "pageSize", defaultValue = "12") Integer pageSize,
	@RequestParam(defaultValue = "") String ch){
	...
	public String project(@PathVariable int id, Model m) {
		Project projectById = projectService.getProjectById(id);
		m.addAttribute("project", projectById);
		return "view_project";
	}
}